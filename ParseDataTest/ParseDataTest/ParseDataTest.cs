...
namespace Hw2
{
    ...
    // Unit Test 1 : To check if the file in the given path is empty. If it is empty the test is failed and message is displayed.
    [TestFixture]
    class ParseDataTest
    {
        [Test]
        ...
        // Unit Test 2 : To check if the grocery file in the given path is getting parsed. 
        // Test passes if the condition in assert matches, else the test fails. The license ID in the given file is 980.
        // Hence this test will pass.
        ...
        // Unit Test 3 : To check if the FoodInpection file in the given path is getting parsed. 
        // Test passes if the condition in assert matches, else the test fails. The license ID in the given file is 2391097
        // Hence this test will pass.
        [Test]
        ...
        // Unit Test 4 : To check if the data in food inspection is for grocery stores and for the year 2013 
        // Test passes if the condition in assert matches, else the test fails. The data in the file is not for grocery store
        // Hence this test will fail.
        [Test]
        ...
        // Test passes if the condition in assert matches, else the test fails. The data in the file is not for the year 2013
        // Hence this test will fail.
        [Test]
        ...
        // Test passes if the condition in assert matches, else the test fails. The data in the file is not for the year 2013 and it is not grocery store
        // Hence this test will fail.
        ...
        // Unit Test 7 : To check if the builidng violations file in the given path is getting parsed. 
        // Test passes if the condition in assert matches, else the test fails. The address in the given file is same as that in the assert condition
        // Hence this test will pass.
        ...
        // Unit Test 8 : To check if the data in grocery store is correlated with data in food inspection and building violations 
